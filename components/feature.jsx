...
const features = [
  ...
  },
  {
    title: "Post Creation",
    description:
      "Share updates, promotions, and announcements to engage your audience.",
  ...
  },
  {
    ...
    description:
      "Provide 24/7 customer assistance with intelligent AI chatbots.",
  ...
  return (
    ...
    >
      <div className="absolute top-0 right-0 opacity-10">
        <IconCircleDotted
          size={120}
          className="text-purple-500 transform rotate-45"
        />
      </div>
      <div className="absolute bottom-0 left-0 opacity-10">
        <IconCircleDotted
          size={80}
          className="text-pink-500 transform -rotate-45"
        />
      </div>
